...
text(best_fpr+0.015, best_tpr-0.01, sprintf(txt1), 'color', 'k', 'FontSize', 10, 'FontWeight', 'bold');
text(best_fpr+0.015, best_tpr-0.02, sprintf(txt2, best_fpr, best_tpr), 'color', 'k', 'FontSize', 10, 'FontWeight', 'bold');
hold on
